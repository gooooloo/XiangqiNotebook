...
struct MacMenuCommands: Commands {
    ...
    var body: some Commands {
        ...
        CommandGroup(after: .toolbar) {
            ...
            menuToggle(.toggleShowRedAttackPoints)
            menuToggle(.toggleShowBlackAttackPoints)
            menuToggle(.toggleAttackPointsRedPalaceOnly)
            menuToggle(.toggleAttackPointsBlackPalaceOnly)
            Divider()
